...
public class AreaChunk {
	...
	public static AreaChunk fromString(String worldName, String string) {
		...
		return new AreaChunk(worldName, Integer.parseInt(data[0]), Integer.parseInt(data[1]));
	}
	...
	public Chunk getChunk() {
		return Objects.requireNonNull(Kingdoms.instance.getServer().getWorld(worldName)).getChunkAt(x, z);
	}
